    ...
    <div class="root">
        ...
        <div class="banner">
            <van-swipe :autoplay="3000">
                <van-swipe-item>
                    <img src="https://dummyimage.com/400x250" alt="">
                </van-swipe-item>
            </van-swipe>
        </div>
        <div class="title">
        ...
        <div class="manager">
            ...
            <a href="tel:10086"><van-button type="default" plain style="borderRadius:30px;color:#38f;borderColor:#38f">电话咨询</van-button></a>
        </div>
    </div>
</template>
